...
<head>
<meta charset="UTF-8">
<title>User: Add Found Pet</title>
...
<div class="container p-4">
    <div class="row">
        <div class="col-md-8 offset-md-2">
            <div class="card">
                <div class="card-body">
                    <h4 class="text-center mb-4">Adaugă anunț animal găsit</h4>
                    ...
                    <form action="../PetsAddFoundServlet" method="post" enctype="multipart/form-data">
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                <label for="found-on"><i class="fas fa-calendar-alt"></i>Găsit în data de</label>
                                <input type="date" class="form-control" id="found-on" name="found_on" required>
                            </div>
                        </div>
